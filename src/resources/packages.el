...
Each  package flycheck-irony not initialized in layer irony, you may consider removing
      this package from the package list or use the :toggle keyword instead of a
      `when' form. entry is either:
...
(defun irony/init-irony ()
  (use-package irony
    ...
    (progn
      ...
      (add-hook 'c++-mode-hook (lambda () (setq irony-additional-clang-options '("-std=c++17"))))
